...
const About = () => {
  ...
  const categories = [
    { name: "Alternative Dispute Resolution", image: "/assets/about/Alternative Dispute Resolution.webp" },
    { name: "Banking & Finance", image: "/assets/about/Banking & Finance.webp" },
    { name: "Building & Construction", image: "/assets/about/Building & Construction.webp" },
    { name: "Commercial Law", image: "/assets/about/Commercial Law.webp" },
    { name: "Commercial Litigation", image: "/assets/about/Commercial Litigation.webp" },
    { name: "Estate Planning & Disputes", image: "/assets/about/Estate Planning & Disputes.webp" },
    { name: "Family Law", image: "/assets/about/Family Law.webp" },
    { name: "Franchising & Licencing", image: "/assets/about/Franchising & Licencing.webp" },
    ...
    <>
      <div className="bg-[url('https://slflawyers.com.au/wp-content/uploads/2023/02/Untitled-design-2023-02-03T120344.159.png')] h-[50vh] bg-cover">
        <div className="text-white flex flex-col justify-center items-center">
          <h1 className="lg:mt-40 md:mt-20 text-white font-semibold text-6xl">
            About SLF Lawyers
          </h1>
        </div>
      </div>
      ...
      <div className="flex flex-wrap md:w-[80%] mx-auto my-10">
        <div className="w-full md:w-2/5 my-20">
          ...
          <div className="bg-white rounded-t-3xl items-center gap-6 py-3 md:flex-row justify-around md:p-10">
          <p className="text-left rtl:text-right text-gray-900 dark:text-gray-800">
            SLF Lawyers is a new breed of law firm. We don't stand on tradition
            or outdated ways of doing business.
          </p>
          <p className="text-left rtl:text-right text-gray-900 dark:text-gray-800 my-4">
            ...
            {categories.map((category, index) => (
              <div key={index} className="w-full md:w-1/3 px-2 mb-10">
                <a href={`/practice-area/${category.name.replace(/ /g, '-').toLowerCase()}`}>
                  <div className="relative mb-9 rounded-xl py-8 px-7 bg-white shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9" style={{ height: '200px', width: '100%' }}>
                    ...
                    <h3 className="pt-16 text-base font-medium text-body-color text-center">
                      {category.name}
                    </h3>
                  </div>
                </a>
